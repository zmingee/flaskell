...
def build_rpm():
    ...
    run("/usr/local/bin/fpm -s dir -t rpm -n {{cookiecutter.repo_name}} -v 0.5.0 -p compute_VERSION_ARCH.rpm /usr/local/bin/{{cookiecutter.repo_name}}/=/usr/local/bin/{{cookiecutter.repo_name}}")
